						...
						<div class="w3l_agileits_breadcrumbs">
							<div class="w3l_agileits_breadcrumbs_inner">
								<ul>
									...
									<li><a href="show_vet_pets.jsp">Show Pets</a><span>«</span></li>
									<li>Pet Details</li>
								...
								<div class="form-body">
									<form class="form-horizontal" id="urchoice">
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" readonly class="form-control1" id="pet_name" placeholder="" name="pet_name" value=<%=flag == null ? "" :pd.getPet_name()%> >
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
												<input type="text" readonly class="form-control1" id="pet_category" name="pet_category" value=<%=flag == null ? "" :pd.getCategory_Name()%> >
												<%-- <select name="pet_category" readonly id="pet_category" class="form-control1" onchange="category_change()">
