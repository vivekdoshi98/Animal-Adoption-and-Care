...
<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info">
						...
						<form action="admin_pet_detail.jsp" method="post">
        ...
        <tbody>
        		<% for (int i=0;i<petList.size();i++)
        		{
        			...
        			//String category = new CategoryDao().getCategoryName(p.getCatergory_id());
        		%>
        		<tr>
        			<td><%=p.getPet_id() %></td>
        			<td><%=p.getPet_name() %></td>
        			...
        			<td> <a href="admin_pet_detail.jsp?id=<%=p.getPet_id()%>">Click to edit</a></td>
        		</tr>	
