...
<%
	ArrayList<AdoptionBean> aList = new ArrayList<AdoptionBean>();
	aList = new PetDao().getAdoptedPets();
...
%>
						...
						<div class="w3l_agileits_breadcrumbs">
							<div class="w3l_agileits_breadcrumbs_inner">
								<ul>
									...
									<li>Show Adoptions</li>
								</ul>
							</div>
						</div>
					<div class="inner_content_w3_agile_info">
						<div class="agile_top_w3_grids">
						<h3 class="w3_inner_tittle two">Adoptions</h3>
        ...
        <tbody>
        	<%for (int i=0; i<aList.size(); i++)
        		{
        			AdoptionBean aBean = aList.get(i);
        	...
        	%>
        		<tr>
        			...
        			<td><%=aBean.getAdoption_date().substring(0,10)%></td>
        	</tr>
        	<% } %>
        	</tbody>
        	</table>
