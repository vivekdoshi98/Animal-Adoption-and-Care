...
<link rel="stylesheet" href="https://cdn.datatables.net/1.10.19/css/jquery.dataTables.min.css">
	...
	function criteria_change(){
		...
		if (c==0)
			...
			$("#date_to_cri").hide();
			$("#date_from_cri").hide();
			$("#reportPetForm").attr('action','../ReportAllPets');
			...
			$("#date_to_cri").show();
			$("#date_from_cri").show();
			$("#reportPetForm").attr('action','../ReportByPetAge');
			...
			$("#category_cri").show();
			$("#breed_cri").show();
			$("#reportPetForm").attr('action','../ReportByPetCategory');
...
<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info">
						...
						<h3 class="w3_inner_tittle two">Reports of Pet</h3>
										
						<div class="grid-1">
						<div class="form-body">
						<form class="form-horizontal" id="reportPetForm">
						<div class="form-group">
							...
							<label class="col-sm-4 control-label">Breed</label>
							 ...
							 <div class="form-group" id="date_from_cri">
								 ...
								 <div class="col-sm-4">
								 <input type="text" id="datepicker1" name="from_age"/>
							</div>
							</div>
							...
							<div class="form-group" id="date_to_cri">								
								 ...
								 <div class="col-sm-4">
								 <input type="text" id="datepicker2" name="to_age"/>								
								</div>		
							</div>
