...
<%
	...
	ArrayList<FinancialDonationBean> qList = new ArrayList<FinancialDonationBean>();
	qList = new FinancialDonationDao().getUserDonations(id);
...
<div class="grid_3 grid_4">
			<h2 style="color: #FF5722; font-size:5em;">Your Donation</h2>
			<table> 
<tr style="background:black 0.5;">
<td  style="text-align:center;font-family:roboto" colspan=2> DONATION DETAILS: </td>  
<%for (int i=0; i<qList.size(); i++)
        		{
        		FinancialDonationBean qb = qList.get(i);
        			
        	%>
 
 <tr>
                <td>Payment Mode</td>
                <td><%=qb.getPayment_type() %></td>
        </tr>
        <tr>
                <td>Payment Amount</td>
                <td><%=qb.getPayment_amount()%></td>
        </tr>
        <tr>
                <td>Payment Date</td>
                <td><%=qb.getPayment_date().substring(0,11) %></td>
        </tr>
         <tr>
