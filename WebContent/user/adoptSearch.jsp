...
<%int cid=Integer.parseInt(request.getParameter("pet_category"));
  int bid=	Integer.parseInt(request.getParameter("breed"));
  ArrayList<PetBean> petList = new PetDao().getPetByCategory_Breed(cid, bid);
	...
	<div class="form-group">
		...
		<td>
											<div class="form-group">
												...
												<div class="col-sm-8">
												<select name="breed" id="breed" class="form-control1" onchange="category_change()">
