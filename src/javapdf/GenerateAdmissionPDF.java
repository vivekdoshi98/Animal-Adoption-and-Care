...
public class GenerateAdmissionPDF {
	...
	public static void createAdmissionByCategoryPDF(String file,ArrayList<AdmissionBean> adopBean)
	{
		...
		try {
			...
			createAdmissionTable(document,adopBean);
	...
	private static void createAdmissionTable(Document document,ArrayList<AdmissionBean> adopList) throws DocumentException {
		...
		for (int i = 0; i < adopList.size(); i++) {
			AdmissionBean adopBean = adopList.get(i);
			...
			table.addCell((adopBean.getAdmission_date()).substring(0, 11));
	...
	private static void addMetaData(Document document) {
		...
		document.addSubject("Animal Admissions REPORT");
	...
	private static void addTitlePage(Document document)
		...
		preface.add(new Paragraph("Animals Admissions Report", HELVETICA));
